...
import sms from "../assets/portfolio/sms.png";
...
const Portfolio = () => {
  const portfolios = [
    ...
    },
    {
      id: 4,
      src: devbook,
      link: "https://github.com/xujalz/Dev-Book",
      color: "shadow-yellow-800",
    },
    {
      id: 5,
      src: sms,
      link: "https://github.com/xujalz/Student-Management-App",
      color: "shadow-purple-800",
    },
    {
      id: 6,
      src: portfolioImg,
      link: "http://localhost:3000/My-Portfolio",
      color: "shadow-white",
    },
  ];
  ...
  return (
    <div
      name="projects"
      className="bg-gradient-to-b from-black to-gray-800 w-full text-white sm:h-screen pt-60"
    >
